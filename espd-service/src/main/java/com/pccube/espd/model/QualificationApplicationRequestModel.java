...
/**
 * Corresponding to {@link QualificationApplicationRequestType}.
 * 
 * Created by MPetruzzi on 14/09/18.
 */
public class QualificationApplicationRequestModel extends BaseModel implements Serializable {
	 ...
	 * constructor
	 */
	public QualificationApplicationRequestModel() {
	 ...
	 */
	public QualificationApplicationRequestModel(boolean init) {
		if (init) {
