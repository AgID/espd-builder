...
import com.pccube.espd.delegate.LanguageServiceDelegate;
...
public class LanguageController extends GenericController {
	...
	static final Logger logger = Logger.getLogger(LanguageController.class);

    @Autowired
    private LanguageServiceDelegate delegate;
	...
	public ResponseEntity<Response> list(HttpServletRequest request, HttpServletResponse response) {
		...
		logger.info(LOG_START_REST_CONTROLLER + "/language/list");
