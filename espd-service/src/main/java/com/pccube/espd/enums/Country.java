...
public enum Country {
	...
	public static final List<Country> COUNTRIES = Collections.unmodifiableList(Arrays.asList(values()));

	private static final Map<String, Country> BY_ISO2_CODE = new HashMap<>(COUNTRIES.size());
