...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:espd="urn:com:grow:espd:2.0.2" xmlns:cac="urn:X-test:UBL:Pre-award:CommonAggregate" xmlns:cbc="urn:X-test:UBL:Pre-award:CommonBasic" xmlns:util="java.util.UUID">
		...
		<xsl:for-each select="ancestor-or-self::table:table-row/table:table-cell">
			<xsl:if test="text:p = '{REQUIREMENT}'">
				...
				<xsl:choose>
					...
					<xsl:when test="$propertyDataType = 'CODE_LOTS'">
						<cbc:ExpectedCode listID="LOTs" listAgencyID="EU-COM-GROW" listVersionID="2.0.2">
							<xsl:value-of select="$value"/>
						</cbc:ExpectedCode>
					</xsl:when>
					<xsl:when test="$propertyDataType = 'CODE_CPVS'">
						<cbc:ExpectedCode listID="CPVs" listAgencyID="EU-COM-GROW" listVersionID="2.0.2">
							<xsl:value-of select="$value"/>
						</cbc:ExpectedCode>
					</xsl:when>
					<xsl:when test="$propertyDataType = 'CODE_BID'">
						<cbc:ExpectedCode listID="BidType" listAgencyID="EU-COM-OP" listVersionID="1.0">
							<xsl:value-of select="$value"/>
						</cbc:ExpectedCode>
					</xsl:when>
					<xsl:when test="$propertyDataType = 'CODE_RATIO'">
						<cbc:ExpectedCode listID="FinancialRatioType" listAgencyID="BACH" listVersionID="1.0">
							<xsl:value-of select="$value"/>
						</cbc:ExpectedCode>
					</xsl:when>
