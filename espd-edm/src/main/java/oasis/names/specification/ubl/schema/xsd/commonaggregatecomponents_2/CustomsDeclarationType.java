...
public class CustomsDeclarationType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CustomsDeclarationType that = ((CustomsDeclarationType) object);
        {
            IDType lhsID;
            lhsID = this.getID();
            IDType rhsID;
