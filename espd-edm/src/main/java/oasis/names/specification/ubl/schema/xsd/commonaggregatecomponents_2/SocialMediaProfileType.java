...
/**
 * <p>Classe Java per SocialMediaProfileType complex type.
 * 
...
public class SocialMediaProfileType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    /**
     * Recupera il valore della proprietà socialMediaTypeCode.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà socialMediaTypeCode.
     * 
     * @param value
     *     allowed object is
     *     {@link SocialMediaTypeCodeType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            SocialMediaTypeCodeType theSocialMediaTypeCode;
            theSocialMediaTypeCode = this.getSocialMediaTypeCode();
            strategy.appendField(locator, this, "socialMediaTypeCode", buffer, theSocialMediaTypeCode, (this.socialMediaTypeCode!= null));
        }
        {
            URIType theURI;
            theURI = this.getURI();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SocialMediaProfileType that = ((SocialMediaProfileType) object);
        {
            IDType lhsID;
            lhsID = this.getID();
            IDType rhsID;
        ...
        {
            SocialMediaTypeCodeType lhsSocialMediaTypeCode;
            lhsSocialMediaTypeCode = this.getSocialMediaTypeCode();
            SocialMediaTypeCodeType rhsSocialMediaTypeCode;
            rhsSocialMediaTypeCode = that.getSocialMediaTypeCode();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "socialMediaTypeCode", lhsSocialMediaTypeCode), LocatorUtils.property(thatLocator, "socialMediaTypeCode", rhsSocialMediaTypeCode), lhsSocialMediaTypeCode, rhsSocialMediaTypeCode, (this.socialMediaTypeCode!= null), (that.socialMediaTypeCode!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            SocialMediaTypeCodeType theSocialMediaTypeCode;
            theSocialMediaTypeCode = this.getSocialMediaTypeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "socialMediaTypeCode", theSocialMediaTypeCode), currentHashCode, theSocialMediaTypeCode, (this.socialMediaTypeCode!= null));
        }
        {
            URIType theURI;
            theURI = this.getURI();
