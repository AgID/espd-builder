...
public class DimensionType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "minimumMeasure", buffer, theMinimumMeasure, (this.minimumMeasure!= null));
        }
        {
            MaximumMeasureType theMaximumMeasure;
            theMaximumMeasure = this.getMaximumMeasure();
            strategy.appendField(locator, this, "maximumMeasure", buffer, theMaximumMeasure, (this.maximumMeasure!= null));
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "minimumMeasure", lhsMinimumMeasure), LocatorUtils.property(thatLocator, "minimumMeasure", rhsMinimumMeasure), lhsMinimumMeasure, rhsMinimumMeasure, (this.minimumMeasure!= null), (that.minimumMeasure!= null))) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "maximumMeasure", lhsMaximumMeasure), LocatorUtils.property(thatLocator, "maximumMeasure", rhsMaximumMeasure), lhsMaximumMeasure, rhsMaximumMeasure, (this.maximumMeasure!= null), (that.maximumMeasure!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            MinimumMeasureType theMinimumMeasure;
            theMinimumMeasure = this.getMinimumMeasure();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "minimumMeasure", theMinimumMeasure), currentHashCode, theMinimumMeasure, (this.minimumMeasure!= null));
        }
        {
            MaximumMeasureType theMaximumMeasure;
            theMaximumMeasure = this.getMaximumMeasure();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "maximumMeasure", theMaximumMeasure), currentHashCode, theMaximumMeasure, (this.maximumMeasure!= null));
        }
