...
/**
 * <p>Classe Java per TaxSchemeType complex type.
 * 
...
public class TaxSchemeType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "taxTypeCode", buffer, theTaxTypeCode, (this.taxTypeCode!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "taxTypeCode", lhsTaxTypeCode), LocatorUtils.property(thatLocator, "taxTypeCode", rhsTaxTypeCode), lhsTaxTypeCode, rhsTaxTypeCode, (this.taxTypeCode!= null), (that.taxTypeCode!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            TaxTypeCodeType theTaxTypeCode;
            theTaxTypeCode = this.getTaxTypeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "taxTypeCode", theTaxTypeCode), currentHashCode, theTaxTypeCode, (this.taxTypeCode!= null));
        }
        {
            CurrencyCodeType theCurrencyCode;
            theCurrencyCode = this.getCurrencyCode();
