...
/**
 * <p>Classe Java per AirTransportType complex type.
 * 
...
public class AirTransportType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    /**
     * Recupera il valore della proprietà aircraftID.
     * 
     * @return
     *     possible object is
     *     {@link AircraftIDType }
    ...
    /**
     * Imposta il valore della proprietà aircraftID.
     * 
     * @param value
     *     allowed object is
     *     {@link AircraftIDType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "aircraftID", buffer, theAircraftID, (this.aircraftID!= null));
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AirTransportType that = ((AirTransportType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "aircraftID", lhsAircraftID), LocatorUtils.property(thatLocator, "aircraftID", rhsAircraftID), lhsAircraftID, rhsAircraftID, (this.aircraftID!= null), (that.aircraftID!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            AircraftIDType theAircraftID;
            theAircraftID = this.getAircraftID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "aircraftID", theAircraftID), currentHashCode, theAircraftID, (this.aircraftID!= null));
        }
