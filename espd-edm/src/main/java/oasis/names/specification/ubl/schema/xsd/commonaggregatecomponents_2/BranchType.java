...
public class BranchType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "financialInstitution", buffer, theFinancialInstitution, (this.financialInstitution!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "financialInstitution", lhsFinancialInstitution), LocatorUtils.property(thatLocator, "financialInstitution", rhsFinancialInstitution), lhsFinancialInstitution, rhsFinancialInstitution, (this.financialInstitution!= null), (that.financialInstitution!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            FinancialInstitutionType theFinancialInstitution;
            theFinancialInstitution = this.getFinancialInstitution();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "financialInstitution", theFinancialInstitution), currentHashCode, theFinancialInstitution, (this.financialInstitution!= null));
        }
        {
            AddressType theAddress;
            theAddress = this.getAddress();
