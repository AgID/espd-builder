...
/**
 * <p>Classe Java per InventoryReportLineType complex type.
 * 
...
public class InventoryReportLineType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    /**
     * Recupera il valore della proprietà inventoryValueAmount.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà inventoryValueAmount.
     * 
     * @param value
     *     allowed object is
     *     {@link InventoryValueAmountType }
    ...
    /**
     * Recupera il valore della proprietà inventoryLocation.
     * 
     * @return
     *     possible object is
     *     {@link LocationType }
    ...
    /**
     * Imposta il valore della proprietà inventoryLocation.
     * 
     * @param value
     *     allowed object is
     *     {@link LocationType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            InventoryValueAmountType theInventoryValueAmount;
            theInventoryValueAmount = this.getInventoryValueAmount();
            strategy.appendField(locator, this, "inventoryValueAmount", buffer, theInventoryValueAmount, (this.inventoryValueAmount!= null));
        }
        {
        ...
        {
            LocationType theInventoryLocation;
            theInventoryLocation = this.getInventoryLocation();
            strategy.appendField(locator, this, "inventoryLocation", buffer, theInventoryLocation, (this.inventoryLocation!= null));
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final InventoryReportLineType that = ((InventoryReportLineType) object);
        {
            IDType lhsID;
            lhsID = this.getID();
            IDType rhsID;
        ...
        {
            InventoryValueAmountType lhsInventoryValueAmount;
            lhsInventoryValueAmount = this.getInventoryValueAmount();
            InventoryValueAmountType rhsInventoryValueAmount;
            rhsInventoryValueAmount = that.getInventoryValueAmount();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "inventoryValueAmount", lhsInventoryValueAmount), LocatorUtils.property(thatLocator, "inventoryValueAmount", rhsInventoryValueAmount), lhsInventoryValueAmount, rhsInventoryValueAmount, (this.inventoryValueAmount!= null), (that.inventoryValueAmount!= null))) {
                return false;
            }
        }
        {
        ...
        {
            LocationType lhsInventoryLocation;
            lhsInventoryLocation = this.getInventoryLocation();
            LocationType rhsInventoryLocation;
            rhsInventoryLocation = that.getInventoryLocation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "inventoryLocation", lhsInventoryLocation), LocatorUtils.property(thatLocator, "inventoryLocation", rhsInventoryLocation), lhsInventoryLocation, rhsInventoryLocation, (this.inventoryLocation!= null), (that.inventoryLocation!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            InventoryValueAmountType theInventoryValueAmount;
            theInventoryValueAmount = this.getInventoryValueAmount();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "inventoryValueAmount", theInventoryValueAmount), currentHashCode, theInventoryValueAmount, (this.inventoryValueAmount!= null));
        }
        {
            AvailabilityDateType theAvailabilityDate;
            theAvailabilityDate = this.getAvailabilityDate();
        ...
        }
        {
            LocationType theInventoryLocation;
            theInventoryLocation = this.getInventoryLocation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "inventoryLocation", theInventoryLocation), currentHashCode, theInventoryLocation, (this.inventoryLocation!= null));
        }
