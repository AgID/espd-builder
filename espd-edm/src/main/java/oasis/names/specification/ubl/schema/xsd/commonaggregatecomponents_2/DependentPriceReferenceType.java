...
public class DependentPriceReferenceType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    /**
     * Recupera il valore della proprietà locationAddress.
     * 
     * @return
     *     possible object is
     *     {@link AddressType }
    ...
    /**
     * Recupera il valore della proprietà dependentLineReference.
     * 
     * @return
     *     possible object is
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "locationAddress", buffer, theLocationAddress, (this.locationAddress!= null));
        }
        {
            LineReferenceType theDependentLineReference;
            theDependentLineReference = this.getDependentLineReference();
            strategy.appendField(locator, this, "dependentLineReference", buffer, theDependentLineReference, (this.dependentLineReference!= null));
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "locationAddress", lhsLocationAddress), LocatorUtils.property(thatLocator, "locationAddress", rhsLocationAddress), lhsLocationAddress, rhsLocationAddress, (this.locationAddress!= null), (that.locationAddress!= null))) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dependentLineReference", lhsDependentLineReference), LocatorUtils.property(thatLocator, "dependentLineReference", rhsDependentLineReference), lhsDependentLineReference, rhsDependentLineReference, (this.dependentLineReference!= null), (that.dependentLineReference!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            AddressType theLocationAddress;
            theLocationAddress = this.getLocationAddress();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "locationAddress", theLocationAddress), currentHashCode, theLocationAddress, (this.locationAddress!= null));
        }
        {
            LineReferenceType theDependentLineReference;
            theDependentLineReference = this.getDependentLineReference();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dependentLineReference", theDependentLineReference), currentHashCode, theDependentLineReference, (this.dependentLineReference!= null));
        }
