...
/**
 * <p>Classe Java per CreditNoteLineType complex type.
 * 
...
public class CreditNoteLineType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    /**
     * Recupera il valore della proprietà creditedQuantity.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà creditedQuantity.
     * 
     * @param value
     *     allowed object is
     *     {@link CreditedQuantityType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            CreditedQuantityType theCreditedQuantity;
            theCreditedQuantity = this.getCreditedQuantity();
            strategy.appendField(locator, this, "creditedQuantity", buffer, theCreditedQuantity, (this.creditedQuantity!= null));
        }
        {
        ...
        {
            List<CreditNoteLineType> theSubCreditNoteLine;
            theSubCreditNoteLine = (((this.subCreditNoteLine!= null)&&(!this.subCreditNoteLine.isEmpty()))?this.getSubCreditNoteLine():null);
            strategy.appendField(locator, this, "subCreditNoteLine", buffer, theSubCreditNoteLine, ((this.subCreditNoteLine!= null)&&(!this.subCreditNoteLine.isEmpty())));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CreditNoteLineType that = ((CreditNoteLineType) object);
        {
            IDType lhsID;
            lhsID = this.getID();
            IDType rhsID;
        ...
        {
            CreditedQuantityType lhsCreditedQuantity;
            lhsCreditedQuantity = this.getCreditedQuantity();
            CreditedQuantityType rhsCreditedQuantity;
            rhsCreditedQuantity = that.getCreditedQuantity();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "creditedQuantity", lhsCreditedQuantity), LocatorUtils.property(thatLocator, "creditedQuantity", rhsCreditedQuantity), lhsCreditedQuantity, rhsCreditedQuantity, (this.creditedQuantity!= null), (that.creditedQuantity!= null))) {
                return false;
            }
        }
        {
        ...
        {
            List<CreditNoteLineType> lhsSubCreditNoteLine;
            lhsSubCreditNoteLine = (((this.subCreditNoteLine!= null)&&(!this.subCreditNoteLine.isEmpty()))?this.getSubCreditNoteLine():null);
            List<CreditNoteLineType> rhsSubCreditNoteLine;
            rhsSubCreditNoteLine = (((that.subCreditNoteLine!= null)&&(!that.subCreditNoteLine.isEmpty()))?that.getSubCreditNoteLine():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "subCreditNoteLine", lhsSubCreditNoteLine), LocatorUtils.property(thatLocator, "subCreditNoteLine", rhsSubCreditNoteLine), lhsSubCreditNoteLine, rhsSubCreditNoteLine, ((this.subCreditNoteLine!= null)&&(!this.subCreditNoteLine.isEmpty())), ((that.subCreditNoteLine!= null)&&(!that.subCreditNoteLine.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            CreditedQuantityType theCreditedQuantity;
            theCreditedQuantity = this.getCreditedQuantity();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "creditedQuantity", theCreditedQuantity), currentHashCode, theCreditedQuantity, (this.creditedQuantity!= null));
        }
        {
            LineExtensionAmountType theLineExtensionAmount;
            theLineExtensionAmount = this.getLineExtensionAmount();
        ...
        }
        {
            List<CreditNoteLineType> theSubCreditNoteLine;
            theSubCreditNoteLine = (((this.subCreditNoteLine!= null)&&(!this.subCreditNoteLine.isEmpty()))?this.getSubCreditNoteLine():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "subCreditNoteLine", theSubCreditNoteLine), currentHashCode, theSubCreditNoteLine, ((this.subCreditNoteLine!= null)&&(!this.subCreditNoteLine.isEmpty())));
        }
        {
            PriceExtensionType theItemPriceExtension;
            theItemPriceExtension = this.getItemPriceExtension();
