 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;ccts:Definition xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:cct="urn:un:unece:uncefact:data:specification:CoreComponentTypeSchemaModule:2" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;A number of monetary units specified in a currency
 * 					where the unit of the currency is explicit or implied.&lt;/ccts:Definition&gt;
 * </pre>
 * 
 * <pre>
...
public class AmountType implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "currencyID", buffer, theCurrencyID, (this.currencyID!= null));
        }
        {
            String theCurrencyCodeListVersionID;
            theCurrencyCodeListVersionID = this.getCurrencyCodeListVersionID();
            strategy.appendField(locator, this, "currencyCodeListVersionID", buffer, theCurrencyCodeListVersionID, (this.currencyCodeListVersionID!= null));
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "currencyID", lhsCurrencyID), LocatorUtils.property(thatLocator, "currencyID", rhsCurrencyID), lhsCurrencyID, rhsCurrencyID, (this.currencyID!= null), (that.currencyID!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            String theCurrencyID;
            theCurrencyID = this.getCurrencyID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "currencyID", theCurrencyID), currentHashCode, theCurrencyID, (this.currencyID!= null));
        }
        {
            String theCurrencyCodeListVersionID;
            theCurrencyCodeListVersionID = this.getCurrencyCodeListVersionID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "currencyCodeListVersionID", theCurrencyCodeListVersionID), currentHashCode, theCurrencyCodeListVersionID, (this.currencyCodeListVersionID!= null));
        }
