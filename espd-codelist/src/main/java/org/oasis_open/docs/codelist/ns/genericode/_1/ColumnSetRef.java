 ...
 *                     An application may use the CanonicalVersionUri to select a local copy of the
 *                     column set or code list. Otherwise the LocationUri value(s) may be tried in
 *                     order, until a valid column set or code list document is retrieved. An
 *                     application must signal an error to the user if it is not able to retrieve a
 *                     column set or code list document to match the column set reference.&lt;/rule:text&gt;
 * </pre>
 * 
 *             
 * 
 * <p>Classe Java per ColumnSetRef complex type.
 * 
...
public class ColumnSetRef {
     ...
     *                     
     * <pre>
     * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;rule:text xmlns:rule="http://docs.oasis-open.org/codelist/ns/rule/1.0/" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" category="application" id="R18"&gt;xml:base does not apply to canonical
     *                         URIs.&lt;/rule:text&gt;
     * </pre>
     * 
     *                 
