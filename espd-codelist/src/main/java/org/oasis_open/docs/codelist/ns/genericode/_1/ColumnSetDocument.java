...
/**
 * Document type for the definition of a column set, which is a set of
 *                 code list columns and/or keys.
 * 
 * <p>Classe Java per ColumnSetDocument complex type.
 * 
...
@XmlType(name = "ColumnSetDocument", propOrder = {
    "annotation",
    "identification",
    "columnChoice",
    "keyChoice"
})
public class ColumnSetDocument {
     ...
     *                     
     * <pre>
     * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;rule:text xmlns:rule="http://docs.oasis-open.org/codelist/ns/rule/1.0/" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" category="application" id="R16"&gt;xml:base does not apply to canonical
     *                         URIs.&lt;/rule:text&gt;
     * </pre>
     * 
     *                 
